<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addstu.aspx.cs" Inherits="SMSstudent.SMSystem.addstu" %>
                ...
                <table class="table1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 160px; height: 18px">
                            <asp:TextBox ID="TextBox7" runat="server" CssClass="text" Width="146px" ReadOnly="True">0</asp:TextBox></td>
